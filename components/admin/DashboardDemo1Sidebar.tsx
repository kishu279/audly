        ...
        <SidebarContent className="bg-[#000000]">
            ...
            <SidebarGroupContent>
              <SidebarMenu>
                {[
                  ...
                  <motion.div key={tab} custom={i} initial="hidden" animate="visible" variants={itemVariants}>
                    <SidebarMenuItem>
                      <SidebarMenuButton
          ...
          <SidebarGroup className="pt-3">
            ...
            <SidebarGroupContent>
              <SidebarMenu>
                {[
                  { label: "PAYMENT STATUS", tab: "payment_status", danger: false },
                  { label: "CANCEL PAYMENT", tab: "cancel_payment", danger: true },
                ].map(({ label, tab, danger }, i) => (
                  <motion.div key={tab} custom={4 + i} initial="hidden" animate="visible" variants={itemVariants}>
                    <SidebarMenuItem>
                      <SidebarMenuButton
                        isActive={activeTab === tab}
                        onClick={() => setActiveTab(tab as any)}
